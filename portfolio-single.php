...
$select_work1 = "SELECT * FROM works WHERE id=$id";
$select_work_res1 = mysqli_query($db_connection, $select_work1);
$after_assoc1= mysqli_fetch_assoc($select_work_res1);

$user_id= $after_assoc1['user_id'];
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="uploads/work/feat_image/<?=$after_assoc1['feat_image'] ?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2><?=$after_assoc1['title'] ?></h2>
                                    <p><?=$after_assoc1['desp'] ?></p>
                                    <div class="blog-list-meta">
                                        <ul>
                                            ...
                                            <li class="blog-post-share">
                                                ...
                                                <a href="https://www.twitter.com/sharer?u=portfolio-single.php?id=<?=$id?>"><i class="fab fa-twitter"></i></a>
                                        ...
                                        <li>
                                            <div class="post-avatar-img">
                                                ...
                                                <img src="img/blog/post_avatar_img.png" alt="img">
                                                  <?php  } else{ ?>
                                                    <img width="100" src="uploads/user photos/<?=$after_assoc_user['photo']?>" alt="img">
                                                  <?php } ?>
                                            </div>
