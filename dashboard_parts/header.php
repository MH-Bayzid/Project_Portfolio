...
$select_message_res = mysqli_query($db_connection, $select_message);



// message count
$count_message = "SELECT COUNT(*) as total FROM messages WHERE status=0";
$count_message_res = mysqli_query($db_connection, $count_message);
$after_assoc_message = mysqli_fetch_assoc($count_message_res);
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="/Raze/dashboard_asset/images/favicon.png">
	<link rel="stylesheet" href="/Raze/dashboard_asset/vendor/chartist/css/chartist.min.css">
    <link href="/Raze/dashboard_asset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="/Raze/dashboard_asset/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="/Raze/dashboard_asset/css/style.css" rel="stylesheet">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
			...
			<img class="logo-compact" src="/Register form/dashboard_asset/images/portfolio.png" alt="">
                <img width="200" class="brand-title" src="/Raze/dashboard_asset/images/logo-text.png" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-toggle="dropdown">
									...
									<div class="pulse-css"><span><?=$after_assoc_message['total']?></span></div>
                                </a>
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										
										<ul class="timeline list-group collapse navbar-collapse" id="#side-menu-collapse">
										<?php
										date_default_timezone_set('Asia/Dhaka');
										 foreach($select_message_res as $mesg){ ?>
											<li>
												<a href="view_message.php?id=<?=$mesg['id']?>">
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="../dashboard_asset/images/avatar/1.jpg">
													</div>
													<div class="media-body">
														<h6 class="mb-1"><?=$mesg['name']?></h6>
														<small class="d-block"><?= date($mesg['date']) ?></small>
													</div>
												</div>
												</a>
											</li>
                            ...
                            <li class="nav-item dropdown header-profile">
								...
								<?php if($after_assoc['photo'] == null){?>
									<img src="/Register form/dashboard_asset/images/profile/17.jpg" width="20" alt="">								
								<?php } else{?>
									<img width="20" src="/Register form/uploads/user photos/<?=$after_assoc['photo']?>" alt="">
									<?php } ?>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/Register form/user/profile.php" class="dropdown-item ai-icon">
                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                        <span class="ml-2">Profile </span>
                                    </a>
                                    
                                    <a href="/Register form/logout.php" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="/Register form/dashboard.php" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">Dashboard</span>
						</a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<!-- <i class="flaticon-preserver"></i> -->
							<i style="font-family: fontawesome;" class="fa-solid fa-users"></i>
							<span class="nav-text">Users</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="/Register form/user/users.php">User List</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="fa fa-bars" aria-hidden="true"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/Register form/menu/menu.php">Add menu</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="fa fa-low-vision" aria-hidden="true"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/Register form/logo/add_logo.php">Add Logo</a></li>
                        </ul>
                    </li>
					...
					<i class="fa fa-bandcamp" aria-hidden="true"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/Register form/banner/banner.php">Edit Banner</a></li>
                        </ul>
                    </li>
					...
					<i class="fa fa-bullhorn" aria-hidden="true"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/Register form/social/social.php"> Social Icon</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="fa fa-superpowers" aria-hidden="true"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/Register form/skill/skill.php"> Add New Skills</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="fa fa-compress" aria-hidden="true"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/Register form/contact/contact.php"> Edit Contact Informations</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="fa fa-paper-plane-o" aria-hidden="true"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/Register form/service/service.php"> Add your service</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="fa fa-briefcase" aria-hidden="true"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/Register form/work/work.php"> Add your work</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="fa fa-forumbee" aria-hidden="true"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/Register form/counter/counter.php"> Add counter</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="fa fa-ravelry" aria-hidden="true"></i>
							<span class="nav-text">Brand Images</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="/Register form/brand/brand.php"> Add Brand</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					<i class="fa fa-comment" aria-hidden="true"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/Register form/message/message.php">Message List</a></li>
                        </ul>
                    </li>
