...
$contact_res =  mysqli_query($db_connection, $contact);
$after_assoc_contact = mysqli_fetch_assoc($contact_res);
...
$after_assoc_banner_photo = mysqli_fetch_assoc($select_banner_photo_res);

//Social
$icon_show = "SELECT * FROM social WHERE status=1";
$icon_show_result = mysqli_query($db_connection, $icon_show);
...
$select_work_res = mysqli_query($db_connection, $select_work);

// Reviews
$select_review = "SELECT * FROM reviews";
$select_review_res = mysqli_query($db_connection, $select_review);
...
$select_counter_res = mysqli_query($db_connection, $select_counter);

//  brand
$select_brand = "SELECT * FROM brand";
$select_brand_res = mysqli_query($db_connection, $select_brand);
    ...
    <body class="theme-bg">
        ...
        <header>
                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    <a href="index.html" class="navbar-brand logo-sticky-none"><img width="150" src="uploads/logo/<?= $after_assoc_logo['logo'] ?>" alt="Logo"></a>
                                    <a href="index.html" class="navbar-brand s-logo-none"><img width="150"src="uploads/logo/<?= $after_assoc_logo['logo'] ?>" alt="Logo"></a>
            ...
            <div class="extra-info">
                ...
                <?php foreach($icon_show_result as $show ){ ?>
                    <a target="_blank" href="<?=$show['link']?>"><i style="font-family: fontawesome;" class="<?=$show['icon']?>"></i></a>
                <?php } ?>
                </div>
            </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-7 col-lg-6">
                            <div class="banner-content">
                                ...
                                <div class="banner-social wow fadeInUp" data-wow-delay="0.8s">
                                    <ul>
                                    <?php foreach($icon_show_result as $show ){ ?>
                                        <li><a href="<?=$show['link']?>"><i style="font-family: fontawesome;" class="<?=$show['icon']?>"></i></a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                        ...
                        <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                            <div class="banner-img text-right">
                                <img src="uploads/banner_photos/<?=$after_assoc_banner_photo['photo']?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4 col-md-6 pitem">
                            <div class="speaker-box">
								<div class="speaker-thumb">
									<img  src="uploads/work/thumbnail/<?=$work['thumb']?>" alt="img">
								</div>
                ...
                <div class="container">
                    <div class="fact-wrap">
                        <div class="row justify-content-between">
                            <?php foreach($select_counter_res as $counter){ ?>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-9 col-lg-10">
                            <div class="testimonial-active">
                                <?php foreach($select_review_res as $reviews){?>
                                <div class="single-testimonial text-center">
                                    <div class="testi-avatar">
                                        <img width="100" src="uploads/review/<?=$reviews['image']?>" alt="img">
                                    </div>
                                    <div class="testi-content">
                                        <h4><span>“</span><?=$reviews['comment']?><span>”</span></h4>
                    ...
                    <div class="row brand-active">
                        ...
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img width="100" src="uploads/brand_image/<?=$brand['image1']?>" alt="img">
                            </div>
                        </div>
                        <?php }?>
                    </div>
