                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <a href="index.html"><img width="200" src="/Register form/dashboard_asset/images/portfolio.png" alt=""></a>
									</div>
                                    <h4 class="text-center mb-4 text-white">Sign up your account</h4>
                                    <form action="register_post.php" method="POST">
                                        <div class="form-group">
                                            <label class="mb-1 text-white"><strong>Name</strong></label>
                                            <input type="text" name="name" class="form-control" placeholder="Name" value="<?=(isset($_SESSION['nam_value'])?$_SESSION['nam_value']:'')?>">
